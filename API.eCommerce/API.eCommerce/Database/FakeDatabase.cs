...
namespace API.eCommerce.Database
{
    public static class FakeDatabase
    {
        ...
        {
            new Item{Product = new ProductDTO{Id = 1, Name="Product 1 WEB", Price=10}, Id=1, Quantity = 1 },
            new Item{Product = new ProductDTO{Id = 2, Name="Product 2 tester", Price=30}, Id=2, Quantity = 2 },
            new Item{Product = new ProductDTO{Id = 3, Name="Product 3 WEB", Price=50}, Id=3, Quantity = 3 },
        };
